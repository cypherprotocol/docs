...
description: 'About Cypher'
---

# About Cypher's Technology!

At Cypher, we build on-chain security tools for protocols. In order to understand why, we have to look at the customer journey through crypto.
...
![User experience](../public/cypher-tech.png)
...
5. Smart contract: sign approvals for unknown transactions, approving unknown behavior, protocol you want to use gets hacked
...
Your team can now experiment more on main-net without worrying about hacks. Just like if you were publishing to a dev environment in cloud infra.
